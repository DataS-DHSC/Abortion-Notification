...
namespace DHSC.ANS.API.Consumer.DTOs
{
	...
	/// even if the practitioner has been unable to confirm that the pregnancy has been terminated (see [Section 4: treatment details](https://www.gov.uk/government/publications/abortion-notification-forms-for-england-and-wales/guidance-notes-for-completing-hsa4-paper-forms#section-4-treatment-details) in the guidanace document).
	/// </para>
	/// <para>
